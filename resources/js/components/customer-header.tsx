    ...
    return (
        <header className="border-border/70 bg-background/92 sticky top-0 z-40 border-b backdrop-blur-xl">
            <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
                ...
                {!minimal && (
                    <div className="bg-card flex min-h-11 items-center gap-2 rounded-full border px-3.5 text-left">
                        <MapPin
                            className="text-primary size-4"
                            aria-hidden="true"
                        />
                        <span>
                            <span className="text-muted-foreground block text-[10px] leading-none font-bold tracking-wider uppercase">
                                {outletName}
                            </span>
