...
export default function AuthSimpleLayout({ children, title, description }: AuthLayoutProps) {
    return (
        <div className="paper-grid relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-background p-5 md:p-10">
            ...
            <div className="relative w-full max-w-md rounded-[2rem] border bg-card/95 p-6 shadow-[0_35px_100px_-55px_rgba(55,42,29,0.7)] backdrop-blur sm:p-9">
