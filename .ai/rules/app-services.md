...
paths:
  ...
  - app/Services/PublicOrderService.php
---
...
## Lock public checkout access
Public checkout must revalidate QR, tenant/outlet/table, and the current subscription inside its transaction. The initial public access lookup can become stale before order creation.
